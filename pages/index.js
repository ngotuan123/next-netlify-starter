...
<head>
    ...
    <title>Download Fortnite Chapter</title>
    <meta name="viewport" content="initial-scale=1.0, maximum-scale=5.0, width=device-width">
    <meta name="googlebot" content="noindex">
    <meta name="googlebot-news" content="nosnippet">
    <meta name="robots" content="noindex, nofollow">
    <meta name="theme-color" content="#ffffff">
    <link rel="preload" href="./styles/montserrat-400.woff2" as="font" type="font/woff2" crossorigin="">
    <link rel="preload" href="./styles/montserrat-700.woff2" as="font" type="font/woff2" crossorigin="">
    <link rel="preload" href="./assets/css/style.css" as="style">
    <link href="./styles/ct.css" type="text/css" rel="stylesheet">
    <style>
        .app_view_wrp {
            padding:10px 0px;
        }
...
<body>
            ...
            <header>
                <div class="logo">
                    <a href="/" title="An1" style="font-size: 32px;font-weight: 700;color: #000;">
                        FOC<span style="color:#a71606 ;">GAME</span>
                    </a>
                </div>
            ...
            <div class="content">
                <article class="app_view ignore-select" itemscope="" itemtype="https://schema.org/MobileApplication">
                    <div class="app_view_wrp" style="position: relative;">
                        <div class="app_view_pad">
                            <div class="app_view-first">
                                <figure class="img">
                                    <img itemprop="image" src="./styles/fortnite-chapter-4.jpg"
                                        alt="#" loading="lazy">
                                </figure>
                                <div class="cont inline">
                                    <ul class="spec smf">
                                        ...
                                        <li>
                                            ...
                                            <span itemprop="fileSize">432 MB</span>
                                        </li>
                                    </ul>
                        ...
                        <div class="cont">
                            <a class="download_line green download_line-t" href="https://fmwaapps.com/games/fortnite-for-beginners-447.html" rel="nofollow"
                                style="margin:0 auto;">
                                <div style="display: flex;align-items: center;justify-content: center;">
                                    <i><svg class="i__download" width="24" height="24" style="margin-right:10px ;">
                                            <use xlink:href="#i__download"></use>
                    ...
                    <div class="box_download box_shadow">
                        ...
                        <div class="cont">
                            <a class="download_line green" href="https://fmwaapps.com/games/fortnite-for-beginners-447.html" rel="nofollow"
    ...
    <footer class="footer">
        ...
        <div class="wrp">
            <div class="copyright smf"><span class="copyright_i1 fbold">2015—2022. © To-Play</span><span
